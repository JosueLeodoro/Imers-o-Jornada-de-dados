...
SELECT
    ...
    ((pp.nosso_preco - pp.preco_medio_concorrentes) / NULLIF(pp.preco_medio_concorrentes, 0)) * 100 AS diferenca_percentual_vs_media,
    ((pp.nosso_preco - pp.preco_minimo_concorrentes) / NULLIF(pp.preco_minimo_concorrentes, 0)) * 100 AS diferenca_percentual_vs_minimo,
    CASE
